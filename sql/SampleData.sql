insert into employees_table(usr_id,emp_or_mgr,first_name,last_name,password,email)
...
--	reimb_manager.reimb_balance, reimb_manager.mgr_usr_id_fk, 
--	reimb_employee.emp_usr_id_fk
--	FROM reimb_employee INNER JOIN reimb_manager 
--	ON reimb_employee.reimb_id = reimb_manager.reimb_id_fk
--	WHERE emp_usr_id_fk = 'dfsg45';
...
--	FROM reimb_employee INNER JOIN reimb_manager 
--	ON reimb_employee.reimb_id = reimb_manager.reimb_id_fk
--	WHERE reimb_employee.emp_usr_id_fk = 'jkrow8';

insert into reimb_table(reimb_id,reimb_status,
			reimb_balance,mgr_usr_id_fk,emp_usr_id_fk)
...
--INSERT INTO reimb_employee(reimb_id_fk,emp_usr_id_fk,emp_fk,reciept_img_path)
...
WHERE reimb_table.emp_usr_id_fk = 'asdf134';
