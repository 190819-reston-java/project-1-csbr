insert into work_table(work_usr_id,emp_or_mgr,first_name,last_name,acc_password,acc_email)
...
insert into reimb_table(reimb_id,reimb_status,
			reimb_balance,work_mgr_id_fk,work_emp_id_fk,mgr_fk,emp_fk)
		values('342rf','PENDING',20.00,'whois','asdf134',false,true);
...
insert into reimb_table(reimb_id,reimb_status,
			reimb_balance,work_mgr_id_fk,work_emp_id_fk,mgr_fk,emp_fk)
		values('034jg0j','PENDING',80.00,'ronson24','jkrow8',false,true);
...
-- example where another user can hijack a request.
INSERT INTO reimb_employee(reimb_id_fk,work_emp_id_fk,emp_fk,reciept_img_path)
	VALUES('35r3o2jr','jkrow8',true,'c:/blah/examplelel.png');	
...
WHERE reimb_table.work_emp_id_fk = 'asdf134';
