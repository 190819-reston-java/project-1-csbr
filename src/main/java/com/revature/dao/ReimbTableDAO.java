...
public class ReimbTableDAO {
	...
	public static ReimbReq getReimbRequest(String username, int type) {

		final String sql = "SELECT * FROM reimb_table " + "WHERE emp_user_id_fk = ? AND reimb_status = ?";
	...
	public static ArrayList<ReimbReq> getReimbRequests(String username, int type, boolean status) {

		String sql = "SELECT * FROM reimb_table " + "WHERE emp_user_id_fk = ?";
